...
parser.add_argument("--moe_router_type", type=str, default="linear", choices=["linear", "vsa_random", "vsa_fpe", "hash", "direct_fpe", "clifford_quat_random", "clifford_quat_fpe", "clifford_complex_random", "clifford_complex_fpe"], help="MoE router type")
